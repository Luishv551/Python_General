...
class RetirementCalculator:
    ...
    def plot_graph(self, monthly_savings, final_amount):
        ...
        # Customize y-axis ticks to display values in dollars without decimals
        formatter = FuncFormatter(lambda x, _: f'${int(x):,}')
        plt.gca().yaxis.set_major_formatter(formatter)

    def save_plot(self, filename, monthly_savings, final_amount):
        self.plot_graph(monthly_savings, final_amount)
...
def main():
    ...
    calculator.save_plot(filename, monthly_savings, final_amount)
